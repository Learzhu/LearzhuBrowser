...
/**
 * AppUtils.java是液总汇的用于获取全局的上下文类。
 *
 * @author Learzhu
 * @version 2.0.0 2017/9/14 16:38
 * @update UserName 2017/9/14 16:38
 * @updateDes
 * @include {@link }
 * @used {@link }
 */
public class AppUtils {
     ...
     * 判断是否
     *
     * @return SDK  26以后会Service变化需要特殊处理
     */
    public static boolean isBuildVersionO() {
