...
/**
 * ArrayUtils.java是液总汇的集合相关的工具类。
 *
 * @author Learzhu
 * @version 2.0.0 2018-03-26 19:33
 * @update Learzhu 2018-03-26 19:33
 * @updateDes
 * @include {@link }
 * @used {@link }
 */
...
public class ArrayUtils {
    ...
    public static boolean isAvailable(List<?> list) {
        return ObjectUtils.isObjectNotNull(list) && list.size() > 0;
    }
     ...
     * @return
     */
    public static <V> boolean isAvailable(V[] sourceArray) {
        return ObjectUtils.isObjectNotNull(sourceArray) && sourceArray.length > 0;
    }
