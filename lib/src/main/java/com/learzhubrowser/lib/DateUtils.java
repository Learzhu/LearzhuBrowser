...
public class DateUtils {
    ...
    //格式化日期00:00:00
    public final static String FORMAT_DATETIME_DAY_START = "yyyy-MM-dd 00:00:00";
    public final static String FORMAT_DATETIME_DAY_END = "yyyy-MM-dd 23:59:59";
    ...
    public static String getFormatDatetimeDayStart(Date date) {
        SimpleDateFormat sdf = new SimpleDateFormat(FORMAT_DATETIME_DAY_START);
